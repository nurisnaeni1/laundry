...
@section('title', 'Halaman Tambah Member')
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('member.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="nama_member" type="text"
                            class="form-control
                        @error('nama_member') is-invalid @enderror"
                            name="nama_member" value="{{ old('nama_member') }}" required autocomplete="name" autofocus>
                        @error('nama_member')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="alamat_member" type="text"
                            class="form-control
                       @error('alamat_member') is-invalid @enderror"
                            name="alamat_member" value="{{ old('alamat_member') }}"required autocomplete="alamat_outlet"
                            autofocus>
                        @error('alamat_member')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="tlp_member" type="text"
                            class="form-control
                       @error('tlp_member') is-invalid @enderror"
                            name="tlp_member" value="{{ old('tlp_member') }}"required autocomplete="tlp_outlet">
                        @error('tlp_member')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
